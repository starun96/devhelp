...
<html lang="en">
  ...
  <body>
    ...
    <body>
      ...
      <form id ="post-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method = "post" href="index.php">
        ...
        <fieldset>
          ...
          <input type="text" id="mail" name="post_price" pattern="^[0-9]*$" oninvalid="setCustomValidity('Enter a Valid Number')" onchange="try{setCustomValidity('')}catch(e){}" required>
