    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <h4>Tinder, but for coders. </h4>
          <p> Search through a variety of programming jobs or developer profiles using our thorough and comprehensive list of filters, such as preferred wage/reward, programming language/platform, skills, experience, and much more! Find your perfect match in just a few clicks.</p>
        </div>
      </div>
    </div>
